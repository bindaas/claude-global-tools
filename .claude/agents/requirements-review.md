...
Otherwise, for every file touched in the diff, read the complete file (not just the diff hunk) from the working tree. You need the full context to judge whether a behavior is fully implemented, partially implemented, or merely scaffolded.
